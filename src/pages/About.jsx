...
const About = () => {
    return (
        <div>
            ...
            <section className="pb-20 border-b border-richblack-700">
                <div className="mx-auto mb-0 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
